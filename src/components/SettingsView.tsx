                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-[var(--text-secondary)] mt-1 mb-4">
                        Automatically export your entire task database, data links, jadwal, and klaim to Google Sheets periodically. You must keep the application open in your browser to process these backups.
                      </p>
